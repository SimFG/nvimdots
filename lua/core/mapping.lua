...
local core_map = {
	...
	["n|˙"] = map_cr("vertical resize -3"):with_silent():with_desc("window: Resize -3 vertically"),
	["n|¬"] = map_cr("vertical resize +3"):with_silent():with_desc("window: Resize +3 vertically"),
	["n|∆"] = map_cr("resize -3"):with_silent():with_desc("window: Resize -3 horizontally"),
	["n|˚"] = map_cr("resize +3"):with_silent():with_desc("window: Resize +3 horizontally"),
	["n|<C-q>"] = map_cr("wq"):with_desc("edit: Save file and quit"),
	["n|Œ"] = map_cr("q!"):with_desc("edit: Force quit"),
